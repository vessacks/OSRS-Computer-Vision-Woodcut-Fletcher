...
class Vision:
    ...
    def find(self, haystack_img, threshold=0.5, debug_mode=None, return_mode = 'bestPoint'): #note: I added return_mode. it's not tested
        ...
        if return_mode == 'allPoints':
            return points
        #return 'points' returns the set of all matches above threshold, return maxLoc returns the best above threshold.
        #as it stands, it will return maxloc when its above threshold, and points (an empty set) when there is nothing above threshold
